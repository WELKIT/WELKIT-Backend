...
public class RetrospectiveController {
    ...
    public ResponseEntity<SuccessResponse<GetAllRetrospectiveResponse>> getAllRetrospectives(
        ...
        List<GetAllRetrospectiveResponse> response = retrospectiveService.getAllRetrospectives(type, page, size, authentication);
    ...
    @GetMapping("/{id}")
    public ResponseEntity<SuccessResponse<RetrospectiveResponse>> getRetrospectiveById(@PathVariable("id") Long retrospectiveId,Authentication authentication) {
        RetrospectiveResponse retrospectiveResponse = retrospectiveService.getRetrospectiveById(retrospectiveId, authentication);
    ...
    @PostMapping
    public ResponseEntity<SuccessResponse<RetrospectiveResponse>> createRetrospective(@Valid @RequestBody RetrospectiveRequest createRetrospectiveRequest, Authentication authentication) {
        RetrospectiveResponse createRetrospectiveResponse = retrospectiveService.createRetrospective(createRetrospectiveRequest, authentication);
    ...
    public ResponseEntity<SuccessResponse<RetrospectiveResponse>> editRetrospective(
            ...
            Authentication authentication) {
        RetrospectiveResponse editRetrospective = retrospectiveService.editRetrospective(retrospectiveId, editRetrospectiveRequest, authentication);
